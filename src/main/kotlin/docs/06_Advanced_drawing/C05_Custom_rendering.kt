...
Drawer."""
    ...
    @Text """## Vertex buffers"""
    @Text """A vertex buffer is a (on the GPU residing) amount of memory in which vertices that describe geometry are
...
Vertex buffers allow geometry to be prepared and stored in such a way that graphics hardware can draw it directly. """
    ...
    @Text """### Declaring a vertex format"""
    @Text """A vertex format declaration consists of a list of vertex attributes. Such a declaration is made using the
...
"""
    ...
    @Text """Listed below are the attributes that can be added to the vertex format.
...
"""
    ...
    @Text """A more complex vertex format declaration would then look like this:"""
    ...
    @Text """### Creating a vertex buffer"""
    @Text """The vertexBuffer() function is used to create a VertexBuffer instance. For example to create a vertex
...
fill the vertex buffer with random data."""
    ...
    @Text """## Shading geometry"""
    @Text """Drawing using Drawer.vertexBuffer will be with respect to the set shade style. Using shade styles the appearance of the geometry in the vertex buffer can be fully customized.
...
The last snippet can be modified to include a simple shading over the geometry"""
    ...
    @Text """## Drawing instances"""
    @Text """The same geometry can be drawn more than once in a single draw call.
