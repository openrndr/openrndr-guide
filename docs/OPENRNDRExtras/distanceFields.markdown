...
# Edit 'src/main/kotlin/docs/10_OPENRNDR_Extras/C220_Distance_fields.kt' instead.
layout: default
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_OPENRNDR_Extras/C220_Distance_fields000.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_OPENRNDR_Extras/C220_Distance_fields001.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_OPENRNDR_Extras/C220_Distance_fields002.kt) 
