...
# Edit 'src/main/kotlin/docs/04_Drawing_basics/C150_ComplexShapes.kt' instead.
layout: default
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/04_Drawing_basics/C150_ComplexShapes000.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/04_Drawing_basics/C150_ComplexShapes001.kt) 
