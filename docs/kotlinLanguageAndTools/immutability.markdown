...
# Edit 'src/main/kotlin/docs/10_Kotlin_language_and_tools/C120_Immutability.kt' instead.
layout: default
title: Immutability
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/10_Kotlin_language_and_tools/C120_Immutability.kt){: .btn .btn-github }