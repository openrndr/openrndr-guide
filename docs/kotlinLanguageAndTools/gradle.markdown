...
# Edit 'src/main/kotlin/docs/10_Kotlin_language_and_tools/C130_Gradle.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/10_Kotlin_language_and_tools/C130_Gradle.kt){: .btn .btn-github }