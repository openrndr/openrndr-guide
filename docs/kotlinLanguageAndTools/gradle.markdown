...
# Edit 'src/main/kotlin/docs/02_Kotlin_lang_and_tools/C110_Gradle.kt' instead.
layout: default
title: What is Gradle?
parent: Kotlin language and tools
last_modified_at: 2023.05.02 15:27:04 +0200
nav_order: 110
has_children: false
---
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/02_Kotlin_lang_and_tools/C110_Gradle.kt){: .btn .btn-github }