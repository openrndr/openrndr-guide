...
# Edit 'src/main/kotlin/docs/10_ORX/C120_Kinect.kt' instead.
layout: default
title: Kinect
parent: ORX
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/10_ORX/C120_Kinect.kt){: .btn .btn-github }