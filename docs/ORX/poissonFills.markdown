...
# Edit 'src/main/kotlin/docs/10_ORX/C210_Poisson_fills.kt' instead.
layout: default
title: Poisson fills
parent: ORX
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_ORX/C210_Poisson_fills000.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_ORX/C210_Poisson_fills001.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_ORX/C210_Poisson_fills002.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/10_ORX/C210_Poisson_fills003.kt) 

[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/10_ORX/C210_Poisson_fills.kt){: .btn .btn-github }