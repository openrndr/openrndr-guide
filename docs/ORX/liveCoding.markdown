...
# Edit 'src/main/kotlin/docs/80_ORX/C130_Live_coding.kt' instead.
layout: default
title: Live coding
parent: ORX
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/80_ORX/C130_Live_coding.kt){: .btn .btn-github }