...
# Edit 'src/main/kotlin/docs/10_ORX/C150_OSC.kt' instead.
layout: default
title: OSC
parent: ORX
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/10_ORX/C150_OSC.kt){: .btn .btn-github }