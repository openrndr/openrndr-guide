...
<video controls preload="none" loop poster="../media/shadestyles-example-003-thumb.jpg">
    <source src="../media/shadestyles-example-003.mp4" type="video/mp4">
</video>
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/30_Drawing/C340_Shade_styles006.kt) 
