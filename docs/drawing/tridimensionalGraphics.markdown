...
# Edit 'src/main/kotlin/docs/04_Drawing/C170_TridimensionalGraphics.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C170_TridimensionalGraphics.kt){: .btn .btn-github }