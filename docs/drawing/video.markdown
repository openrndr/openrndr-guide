...
# Edit 'src/main/kotlin/docs/30_Drawing/C165_Playing_Videos.kt' instead.
layout: default
title: Video
parent: Drawing
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/30_Drawing/C165_Playing_Videos.kt){: .btn .btn-github }