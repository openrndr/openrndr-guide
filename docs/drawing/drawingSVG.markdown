...
# Edit 'src/main/kotlin/docs/04_Drawing/C160_DrawingSvg.kt' instead.
layout: default
title: Drawing SVG
parent: Drawing
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C160_DrawingSvg.kt){: .btn .btn-github }