...
# Edit 'src/main/kotlin/docs/04_Drawing/C305_Render_targets.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C305_Render_targets.kt){: .btn .btn-github }