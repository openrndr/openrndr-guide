...
# Edit 'src/main/kotlin/docs/04_Drawing/C140_ManagingDrawStyle.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C140_ManagingDrawStyle.kt){: .btn .btn-github }