...
# Edit 'src/main/kotlin/docs/04_Drawing/C330_Asynchronous_image_loading.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C330_Asynchronous_image_loading.kt){: .btn .btn-github }