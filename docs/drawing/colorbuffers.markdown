...
# Edit 'src/main/kotlin/docs/04_Drawing/C300_Colorbuffers.kt' instead.
layout: default
title: Color buffers
parent: Drawing
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C300_Colorbuffers.kt){: .btn .btn-github }