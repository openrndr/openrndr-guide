...
# Edit 'src/main/kotlin/docs/04_Drawing/C360_Concurrency_and_multithreading.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C360_Concurrency_and_multithreading.kt){: .btn .btn-github }