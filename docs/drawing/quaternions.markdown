...
# Edit 'src/main/kotlin/docs/04_Drawing/C220_Quaternions.kt' instead.
layout: default
title: Quaternions
parent: Drawing
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C220_Quaternions.kt){: .btn .btn-github }