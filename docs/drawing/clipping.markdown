...
# Edit 'src/main/kotlin/docs/04_Drawing/C320_Clipping.kt' instead.
layout: default
title: Clipping
parent: Drawing
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/04_Drawing/C320_Clipping000.kt) 

[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/04_Drawing/C320_Clipping.kt){: .btn .btn-github }