...
# Edit 'src/main/kotlin/docs/50_Animation/C50_BasicAnimation.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/50_Animation/C50_BasicAnimation.kt){: .btn .btn-github }