...
# Edit 'src/main/kotlin/docs/20_Program_basics/C100_ApplicationProgram.kt' instead.
layout: default
...
[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/20_Program_basics/C100_ApplicationProgram.kt){: .btn .btn-github }