...
# Edit 'src/main/kotlin/docs/06_Advanced_drawing/C140_Shade_styles.kt' instead.
layout: default
title: Shade styles
parent: Advanced drawing
last_modified_at: 2023.05.12 21:18:55 +0200
nav_order: 140
has_children: false
---
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C140_Shade_styles000.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C140_Shade_styles001.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C140_Shade_styles002.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C140_Shade_styles005.kt) 
