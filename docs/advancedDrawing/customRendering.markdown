...
# Edit 'src/main/kotlin/docs/06_Advanced_drawing/C150_Custom_rendering.kt' instead.
layout: default
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C150_Custom_rendering000.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C150_Custom_rendering001.kt) 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/06_Advanced_drawing/C150_Custom_rendering002.kt) 

[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/06_Advanced_drawing/C150_Custom_rendering.kt){: .btn .btn-github }